...
import { TrendingUp, TrendingDown, CreditCard } from '@phosphor-icons/react';
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {getCategoryName(transaction.category)} • {formatDate(transaction.date, userSettings.dateFormat)}
              ...
              <div className="text-right">
                <div className={`font-semibold ${
                  ...
                  {transaction.type === 'income' ? '+' : '-'}{formatCurrency(transaction.amount, userSettings.currency)}
                </div>
